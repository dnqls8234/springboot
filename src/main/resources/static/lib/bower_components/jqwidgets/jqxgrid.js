        ...
        localizestrings: function (localizationobj, refresh) {
            ...
            if (localizationobj != null) {
                ...
                this.gridlocalization = {
                    ...
                    decimalseparator: '.',
                    thousandsseparator: ',',
                    pagergotopagestring: "이동 페이지:",
                    pagershowrowsstring: "행수:",
                    pagerrangestring: " 의 ",
                    pagerpreviousbuttonstring: "previous",
                    pagernextbuttonstring: "다음",
                    pagerfirstbuttonstring: "처음",
                    pagerlastbuttonstring: "마지막",
                ...
                if (this.table && this.table.length > 0 && this.table[0].rows && this.table[0].rows.length > 0) {
                    ...
                    for (var i = 0; i < row.cells.length; i++) {
                        ...
                        if (cell.css('display') != 'none' && !rendered) {
                            ...
                            rendered = true;
                            cell[0].innerHTML = "";
                            var span = $("<span style='white-space: nowrap; float: left; margin-left: 50%; position: relative; font-weight:bold;color:gray'></span>");
